...
protected:
	...
	*/
	...
	__m128 vertices[32][32]; ///< Coordinates of vertexes of the crystal (for intrinsic version)
	unsigned vertexCounts[32]; ///< Numbers of vertices for each facet
...
public:
	...
	*/
	...
	inline int is_not_duplicate(__m128 p1, __m128 p2) const;
